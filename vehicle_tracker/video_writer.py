...
class VideoWriter:
    """Writes annotated frames to a file, sized by the first frame a stream actually delivers."""

    def __init__(self, path: Path, fps: float) -> None:
        # opencv reports a writer to a directory as open and then silently writes nothing
